                  ...
                  <div className="flex w-full gap-[40px_94px] justify-between flex-wrap max-md:max-w-full">
                    <div className="min-w-60 font-medium w-[264px]">
                      <div className="flex items-center gap-2 text-lg text-[#A8A8A8] leading-none">
                        <div className="bg-[#00A656] self-stretch flex w-3 shrink-0 h-3 my-auto rounded-[50%]" />
                        ...
                        <div className="text-[#1B1B1B] opacity-80 self-stretch my-auto">
                          UI8 Studio 2024
                        </div>
                      </div>
                      <div className="text-[#727272] text-[13px] leading-none mt-1">
                        Web app
                      </div>
                    </div>
                    <div className="flex items-center gap-3 justify-center">
                      <div className="fill-[#E2E2E2] self-stretch flex flex-col overflow-hidden items-stretch justify-center w-[104px] my-auto px-[21px] py-[15px] max-md:px-5">
                        <div className="bg-[rgba(114,114,114,0.45)] flex w-12 shrink-0 h-1.5 rounded-sm" />
                      </div>
                      <div className="self-stretch flex min-h-12 items-center gap-4 overflow-hidden justify-center w-12 my-auto p-1 rounded-[90px]">
                        <img
                          src="https://cdn.builder.io/api/v1/image/assets/2548869794224509ad73d4b053631dfd/7f8afc542fe7ad87fb1f155c39de24b517750030?placeholderIfAbsent=true"
                          alt="User avatar"
                          className="aspect-[1] object-contain w-10 self-stretch my-auto rounded-[50%]"
                        />
                      </div>
                    </div>
                  </div>
                  <div className="mt-9 max-md:max-w-full max-md:mr-1">
                    <div className="bg-[rgba(226,226,226,0.3)] flex w-full flex-col overflow-hidden items-stretch justify-center p-8 rounded-2xl max-md:max-w-full max-md:px-5">
                      <div className="w-full max-md:max-w-full">
                        <div className="text-[#1B1B1B] text-sm font-medium leading-none opacity-80 max-md:max-w-full">
                          Introduction
                        </div>
                        <div className="w-full mt-4 max-md:max-w-full">
                          <div className="bg-[rgba(114,114,114,0.1)] flex min-h-1.5 w-[195px] max-w-full rounded-sm" />
                          <div className="bg-[rgba(114,114,114,0.1)] flex min-h-1.5 w-full mt-2.5 rounded-sm max-md:max-w-full" />
                          <div className="bg-[rgba(114,114,114,0.1)] flex min-h-1.5 w-full mt-2.5 rounded-sm max-md:max-w-full" />
                        </div>
                      </div>
                    </div>
                    <div className="bg-[rgba(226,226,226,0.3)] flex w-full flex-col overflow-hidden items-stretch text-sm text-[#1B1B1B] font-medium whitespace-nowrap leading-none justify-center mt-4 p-8 rounded-2xl max-md:max-w-full max-md:px-5">
                      <div className="w-full max-md:max-w-full">
                        Goal
                      </div>
                    </div>
